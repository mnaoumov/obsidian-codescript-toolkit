...
export interface CodeButtonContext {
   ...
   *
   * @see {@link https://github.com/mnaoumov/obsidian-codescript-toolkit/blob/main/demo-vault/41%20Code%20button%20config.md#shouldwrapconsole---console-messages}
   */
  console: Console;
   ...
   *
   * @see {@link https://github.com/mnaoumov/obsidian-codescript-toolkit/blob/main/demo-vault/42%20Code%20button%20context.md#codebuttoncontextcontainer}
   */
