...
The same functions are available inside a code button as [`codeButtonContext`](<../07 Code buttons in depth/43 Code button context.md>); this module is how you reach them from a `.js`/`.ts` file instead.
