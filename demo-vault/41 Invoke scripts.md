...
Which scripts appear, and what each command actually does, is decided by what the script exports — see [Invocable scripts](<./35 Invocable scripts.md>). Notes can be invocable too, via `isInvocable` in their frontmatter ([Markdown files](<./23 Markdown files.md>)).
