...
Every [code button](<./38 Code buttons.md>) can be configured by a YAML block at the top of its source. That is how a button gets a caption, runs itself, cleans itself up afterwards, or shows you the code behind it. All keys are optional, and every key omitted falls back to its default.
