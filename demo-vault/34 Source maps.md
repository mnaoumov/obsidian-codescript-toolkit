...
Open `DevTools Console` with `Ctrl/Command + Shift + I`, then click the button: execution stops at the `debugger` statement, in this note's source, with `variable` and `anotherVariable` inspectable.
