...
The same idea as [Wikilinks](<./08 Wikilinks.md>), for vaults configured to use markdown-style links: `require()` accepts a full markdown link and loads what it points at. Rename the script and Obsidian rewrites the link for you, so the require does not rot.
