...
Load a `.wasm` binary and call its exports like an ordinary module. Unlike [Node binaries](<./14 Node binaries.md>), WebAssembly runs on mobile too — so it is the portable way to use something compiled from Rust, C, or Go inside your vault.
