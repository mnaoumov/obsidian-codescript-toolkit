...
Which scripts appear, and what each command actually does, is decided by what the script exports — see [Invocable scripts](<./37 Invocable scripts.md>). Notes can be invocable too, via `isInvocable` in their frontmatter ([Markdown files](<../02 What you can load/14 Markdown files.md>)).
