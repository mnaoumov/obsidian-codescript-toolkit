This is an [Obsidian](https://obsidian.md/) vault demonstrating features of the [CodeScript Toolkit](https://github.com/mnaoumov/obsidian-codescript-toolkit/) plugin.
...
- **Otherwise**, download `demo-vault-<version>.zip` from the [plugin releases](https://github.com/mnaoumov/obsidian-codescript-toolkit/releases), unzip it, and in Obsidian choose `Manage vaults...` → `Open folder as vault` → select the unzipped folder.
