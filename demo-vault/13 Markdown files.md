...
| `invocableCodeScriptName` | which block to run via [Invoke scripts](<./37 Invoke scripts.md>)                        |
| `isInvocable`             | whether this note appears in the [Invoke scripts](<./37 Invoke scripts.md>) command list |
