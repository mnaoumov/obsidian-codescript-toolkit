 ...
 * `*.demo-vault.integration.test.ts` files were collected by nothing at all — the same shape of silent gap
 * a project declared in one place and not the other produces, from the opposite direction.
 */
